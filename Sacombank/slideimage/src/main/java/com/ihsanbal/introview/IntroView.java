...
public class IntroView extends ViewPager {
    ...
    public void init(FragmentManager fm, List<FeatureObject> featureList,
                     AdapterPageSection.OnItemClickListener onItemClickListener) {
        mAdapterPageSection = new AdapterPageSection(context, fm, mBundle, featureList, onItemClickListener);
